<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['stock:position:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="positionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="持仓日期" align="center" prop="date" width="140" fixed="left">
      ...
      <el-table-column label="可卖数量" align="center" prop="sellNum" />
      <el-table-column label="冻结数量" align="center" prop="freezeNum" />
      <el-table-column label="成本价" align="center" prop="costPrice" />
      <el-table-column label="市场价" align="center" prop="currentPrice" />
      <el-table-column label="市值" align="center" prop="marketValue" />
      <el-table-column label="盈亏" align="center" prop="profitLoss" />
      <el-table-column label="盈亏比" align="center" prop="profitLossRatio" />
...
import { listPosition, exportPosition } from "@/api/stock/position";
