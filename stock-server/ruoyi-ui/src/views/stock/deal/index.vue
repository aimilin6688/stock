<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="买卖标志" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择买卖标志" clearable size="small">
          <el-option
    ...
    <el-table v-loading="loading" :data="dealList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="账号" align="center" prop="account.reportName" />
      <el-table-column label="证券代码" align="center" prop="stockCode" />
      <el-table-column label="证券名称" align="center" prop="stockName" />
      <el-table-column label="成交时间" align="center" prop="dealTime" />
      <el-table-column label="成交数量" align="center" prop="num" />
      <el-table-column label="成交价格" align="center" prop="price" />
      <el-table-column label="成交金额" align="center" prop="money" />
      <el-table-column label="买卖标志" align="center" prop="type" :formatter="typeFormat" />
...
import { listDeal,  exportDeal } from "@/api/stock/deal";
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有成交数据项?', "警告", {
        confirmButtonText: "确定",
        cancelButtonText: "取消",
        type: "warning"
      }).then(function() {
        return exportDeal(queryParams);
      }).then(response => {
